...
/*sdp_resp_dev_addr
sdp_resp_va_maximums
sdp_resp_volt_limit
sdp_resp_va_data
sdp_resp_va_setpoint
sdp_resp_preset
sdp_resp_program
sdp_resp_ldc_info*/
...
int sdp_set_volt(char *buf, int addr);
int sdp_set_curr(char *buf, int addr);
...
int sdp_resp_dev_addr(char *buf, int len, ...);
